...
def test(args):
    ...
    # print("Each sequence has {} {}-framed mini-sequences".format(len(sequences) , len(sequences[0])))
    # print("Printing seq: ", sequences)
